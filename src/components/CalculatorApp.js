        ...
        <div className="bg-blue-500 w-96 h-full pb-5 mx-auto rounded-lg overflow-hidden my-20">
          ...
          <div className="grid grid-cols-4 gap-2 mt-10 mx-3">
            <button
              ...
              className="text-gray bg-white w-20 h-20 rounded-lg font-bold text-xl flex justify-center items-center shadow"
            >
              CLEAR
            </button>
            <button
            ...
            <button
              ...
              className="text-white w-20 h-20 bg-indigo-700 rounded-lg font-bold text-3xl flex justify-center items-center shadow"
            >
              9
            </button>
            <button
